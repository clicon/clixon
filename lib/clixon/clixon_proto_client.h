...
int clixon_rpc_clixon_cache(clixon_handle h, const char *op, const char *type, const char *domain, const char *module, const char *revision, const char *keyword, const char *name, cbuf *data);
