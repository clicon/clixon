...
int netconf_unknown_namespace(cbuf *cb, char *type, char *_namespace, char *message);
int netconf_unknown_namespace_xml(cxobj **xret, char *type, char *_namespace, char *message);
