 ...
 */
int
clixon_event_select_unreg_fd(int   s,
                             int (*fn)(int, void*))
{
    struct event_data *e;
    int                found = 0;
 ...
 */
int
clixon_event_select_unreg_timeout(int (*fn)(int, void*),
                                  void *arg)
{
    struct event_data  *e;
    int                 found = 0;
 ...
 */
int
clixon_event_select_poll(int fd)
{
    int            retval = -1;
    fd_set         fdset;
 ...
 */
int
clixon_event_select_loop(clixon_handle h)
{
    struct event_data *e;
    int                n;
    struct timeval     t;
