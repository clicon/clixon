...
/*! Use cligen cmd name to encode treename: <domain>-<spec>-<module>-<revision>-<keyword>-<argument>
 *
...
yang2cli_tree_encode(cbuf       *cb,
                    ...
                    const char *argument)
{
    if (domain == NULL || spec == NULL || module == NULL || revision == NULL || keyword == NULL || argument == NULL){
 ...
 */
int
yang2cli_tree_decode(const char *cmd,
                     const char *delim,
                     char      **domain,
                     char      **spec,
                     char      **module,
                     ...
                     char      **argument)
{
    ...
    if (cmd == NULL || delim == NULL || keyword == NULL){
              ...
              cbuf         *cb)
{
    ...
    if (yang2cli_tree_encode(cbtree, AUTOCLI_CMD_DELIM,
