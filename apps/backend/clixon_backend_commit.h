...
int backend_update(clixon_handle h, client_entry *ce, db_elmnt *de1, cbuf *cbret);
...
int       xmldb_netconf_name_find(clixon_handle h, cxobj *xn, const char *name, client_entry *ce, db_elmnt **de, cbuf *cbret);
