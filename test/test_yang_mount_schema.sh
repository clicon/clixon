...
expecteof_netconf "$clixon_netconf -qf $cfg" 0 "$DEFAULTHELLO" "<rpc $DEFAULTNS><stats xmlns=\"http://clicon.org/lib\"></stats></rpc>" "<module-set><name>mountpoint: /ex:top/ex:mylist\[ex:name='x'\]/ex:root</name><nr>"
