...
expectpart "$($clixon_cli -1 -f $cfg show compare xml)" 0 "\+\ *<y0 xmlns=\"urn:example:order\">b</y0>" "\+\ *<y0 xmlns=\"urn:example:order\">c</y0>" "\+\ *<y0 xmlns=\"urn:example:order\">d</y0>" "\-\ *<y0 xmlns=\"urn:example:order\">e</y0>" "\-\ *<y0 xmlns=\"urn:example:order\">b</y0>" "\-\ *<y0 xmlns=\"urn:example:order\">c</y0>" "\-\ *<y0 xmlns=\"urn:example:order\">d</y0>"
