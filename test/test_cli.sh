...
<clixon-config xmlns="http://clicon.org/config">
  ...
  <CLICON_CLI_VARONLY>1</CLICON_CLI_VARONLY>
...
expectpart "$($clixon_cli -1 -f $cfg -l o validate)" 255 "Validate failed. Edit and try again or discard changes: application missing-element Missing mandatory XML type node"
